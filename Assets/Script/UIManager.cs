...
public class UIManager : MonoBehaviour
{
    ...
    public Vector2 CanvasCenter { get { return canvasCenter; } }
    ...
    void Awake()
    {
        ...
        canvasCenter = new Vector3(Screen.width / 2, Screen.height / 2);
    }
    ...
    public bool TryGetGraphicRayFindParent<T>(out T behaviour) where T : MonoBehaviour
    {
        results.Clear();
